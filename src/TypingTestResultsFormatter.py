...
class TypingTestResultsFormatter:
    ...
    def add_user(self, usr_name, data) -> None:
        ...
        self.rows_train.append(pd.DataFrame(train_dict, index=[usr_name]))
        self.rows_test.append(pd.DataFrame(test_dict))
        self.__clear()
    ...
    def to_csv(self):
        df_train = pandas.concat(self.rows_train)
        df_train.to_csv('train.csv')
        df_test = pandas.concat(self.rows_train)
